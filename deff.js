...
case 'toimg':  
              ...
              deff.sendMessage(from, buffer, image, {quoted: ftroli, caption: 'Nih Kak Jangan Lupa Subscribe Adiosbotz'})
              fs.unlinkSync(ran)
})
              break
case 'ttp':  
...
case 'tiktok':
              ...
              if (!q.includes('tiktok')) return reply(mess.error.Iv)
              reply(mess.wait)
              bgst =`Jangan Lupa Subscribe Yt Adiosbotz \n Helpme tu 1k subscriber`
...
case 'pinterest':
        ...
        buttons = [{buttonId: `${prefix + command}`,buttonText:{displayText: `➡️Next`},type:1}]
              ...
              contentText:`Nih Kak Subscribe Adiosbotz ya Kak😅`,buttons,headerType:4}
              prep = await deff.prepareMessageFromContent(from,{buttonsMessage},{quoted: ftroli})
              deff.relayWAMessage(prep)
        break
